...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (  0, hashGenesisBlock)
        //(  100, uint256("0xfaeb08cb618641e81397f3fe0bf76e01a8d5ce1e79e088e612462ab5dc84ec00"))
        //(  148, uint256("0xeb984353fc5190f210651f150c40b8a4bab9eeeff0b729fcb3987da694430d70"))
    ...
    static const CCheckpointData data = {
        &mapCheckpoints,
        1459020341, // * UNIX timestamp of last checkpoint block
        0,    // * total number of transactions between genesis and last checkpoint
                    //   (the tx=... number in the SetBestChain debug.log lines)
        80.0     // * estimated number of transactions per day after checkpoint
    };
